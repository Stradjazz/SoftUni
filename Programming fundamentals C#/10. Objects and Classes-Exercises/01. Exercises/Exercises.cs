...
/*Exercises are fun … Especially when they represent a problem from your exercises. Implement a class Exercise, which has a Topic (string), a 
 CourseName (string), a JudgeContestLink (string), and a Problems (collection of strings).
...
namespace _01.Exercises
{
    ...
    class Exercises
    {
        static void Main(string[] args)
        {
            ...
            {
                Exercise currentExercise = ReadExercise(input);
